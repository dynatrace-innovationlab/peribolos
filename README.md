...
> **Note**
> This is an extraction and fork of [Peribolos] from [kubernetes/org].
> 
> There has been no code changes to the original code, therefore the original copyright is still in place
> Within this repository we enrich the original repository with a dedicated CI pipeline and separate releasing of the tool.

> **Note**
> This repository is not officially supported by Dynatrace!
